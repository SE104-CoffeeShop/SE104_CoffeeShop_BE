    ...
    public function run()
    {
        ...
        $vouchers = [
            ...
            [
                ...
                'amount' => 10,
                'quantity' => 10,
                'start_date' => date('Y-m-d', strtotime('01/01/9999')),
                'end_date' => date('Y-m-d', strtotime('10/01/2023')),
            ],
            [
                ...
                'amount' => 10,
                'quantity' => 10,
                'start_date' => date('Y-m-d', strtotime('01/01/0001')),
                'end_date' => date('Y-m-d', strtotime('10/01/2023')),
            ],
            [
            ...
            [
                'voucher_code' => 'TEST_VOUCHER_MINUS_AMOUNT',
                'type' => 'direct',
                'amount' => -10,
                'quantity' => 10,
                'start_date' => date('Y-m-d', strtotime('10/01/2023')),
            ...
            [
                'voucher_code' => 'TEST_VOUCHER_MINUS_QUANTITY',
                'type' => 'direct',
                'amount' => -10,
                'quantity' => -10,
                'start_date' => date('Y-m-d', strtotime('10/01/2023')),
            ...
            [
                'voucher_code' => 'TEST_VOUCHER_QUANTITY_DOUBLE',
                'type' => 'direct',
                'amount' => 10,
                'quantity' => 3.14159,
                'start_date' => date('Y-m-d', strtotime('10/01/2023')),
            ...
            [
                'voucher_code' => 'TEST_VOUCHER_AMOUNT_DOUBLE',
                'type' => 'direct',
                'amount' => 10.41459,
                'quantity' => 3.14159,
                'start_date' => date('Y-m-d', strtotime('10/01/2023')),
